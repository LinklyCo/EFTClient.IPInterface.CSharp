...
namespace PCEFTPOS.EFTClient.IPInterface
{
    ...
    public enum TransactionType
    {
        ...
        PreAuthCancel = 'Q',
        /// <summary>A pre-authorization partial cancel ('O').</summary>
        PreAuthPartialCancel = 'O',
        /// <summary>A pre-authorization Extend ('E').</summary>
        PreAuthExtend = 'E',
        /// <summary>A pre-authorization top-up ('U').</summary>
        PreAuthTopUp = 'U',
        ...
        Deposit = 'D',
        /// <summary>A withdrawal EFT transaction type ('W').</summary>
        Withdrawal = 'W',
        ...
        Void = 'I',
        /// <summary>A Mail Order/Telephone Order EFT transaction type</summary>
        MOTO = 'G',
